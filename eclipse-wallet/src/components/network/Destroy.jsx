...
export default function Destroy(props) {
    ...
    // Creates lock hex
    async function createDestroyHex() {

        props.setPopupComp(<LoadingPopup />)
        props.toggleShowPopup(true)

        const dataChunk = await createDestroy(props.wallet.addressBook[props.wallet.addrIndex].pubKey, assetName, assetQty, (fee * 100000000)).then(
            res => {return res}
        )
    ...
    return (
        <Slide direction="right" in={props.showDestroy} mountOnEnter unmountOnExit>
            <Box sx={{
                ...
                <Card sx={{ width: "100%" }}>
                    ...
                    <Grid xs container>
                            ...
                            <Grid item xs={12} sx={{ p: 2 }}>
                                <Tooltip title="Asset to have issuance destroyed">
                            ...
                            <Grid item xs={12} sx={{ p: 2 }}>
                                <Tooltip title="Quantity of asset to be destroyed">
